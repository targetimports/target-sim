    ...
    <section className="py-24 bg-white">
      <div className="container mx-auto px-4">
        <motion.div
          ...
          viewport={{ once: true }}
          className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-600 via-emerald-500 to-violet-600 p-12 lg:p-20"
        >
          {/* Background Pattern */}
          ...
          <div className="relative z-10 text-center max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-10">
              <Link to={createPageUrl('Subscribe')}>
                <Button size="lg" className="bg-white text-emerald-600 hover:bg-slate-100 px-8 h-14 text-lg rounded-xl shadow-lg w-full sm:w-auto">
                  Assinar agora
